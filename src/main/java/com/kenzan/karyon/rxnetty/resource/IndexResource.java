            ...
            public Observable<Void> handle(HttpServerRequest<ByteBuf> request,
                ...
                .flatMap(new Func1<String, Observable<Void>>() {
                    ...
                    public Observable<Void> call(String body) {
                        ...
                        response.writeString("<html><head><style>body{text-align:center;font-family:'Lucida Grande'}</style></head><body><img src='https://franchiseindia.s3.ap-south-1.amazonaws.com/uploads/content/wi/art/5b1e60282e6e9.jpg' /><h2>Example Spinnaker Petclinic Application</h2><h3>Welcome All!!</h3></body></html>");
